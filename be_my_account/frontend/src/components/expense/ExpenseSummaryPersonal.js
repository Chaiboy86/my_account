...
export class ExpenseSummaryPersonal extends Component {
  static propTypes = {};
  // JSX内で変数を利用する
  ...
  render() {
    return (
      <Fragment>
        {console.log(
          displayIntegerFormat(this.props.summaryPersonal.sum_ammount_month)
        )}
        <Title>{text.SUM_VALUE_PERSONAL}</Title>
